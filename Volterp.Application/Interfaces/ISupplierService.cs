...
public interface ISupplierService
{
    ...
    Task<SupplierDto> CreateSupplierAsync(CreateSupplierRequest request, int companyId, CancellationToken ct = default);
    Task<SupplierDto> UpdateSupplierAsync(int id, int companyId, UpdateSupplierRequest request, CancellationToken ct = default);
