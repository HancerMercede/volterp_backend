...
{
    /// <inheritdoc />
    public partial class AddEmployee_EntityStatus_AuditEntity_Purchase_AccountingTransaction_Models : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AFP = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ARS = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    NSS = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountingTransactions_Category",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountingTransactions_ReferenceNumber",
                table: "AccountingTransactions",
                column: "ReferenceNumber");

            migrationBuilder.CreateIndex(
                name: "IX_AccountingTransactions_Status",
                table: "AccountingTransactions",
                column: "Status");
